...
package com.example.myapplication.samplevideoplayer;
...
public class SampleVideoPlayer {
    ...
    private void initPlayer() {
        ...
        mPlayer =
                ExoPlayerFactory.newSimpleInstance(mContext, renderersFactory, trackSelector, drmSessionManager);
        ...
        /*mPlayer.addAnalyticsListener(new AnalyticsListener() {
            ...
            public void onPlayerStateChanged(EventTime eventTime, boolean playWhenReady, int playbackState) {
                Log.d("SampleVideoPlayer", "onPlayerStateChanged: "+playbackState);
            }

            @Override
            public void onDownstreamFormatChanged(EventTime eventTime, MediaSourceEventListener.MediaLoadData mediaLoadData) {
                Log.d("SampleVideoPlayer", "onDownstreamFormatChanged: "+mediaLoadData.trackFormat.bitrate);
            }
        });*/
    }
    ...
    public void release() {
        if (mPlayer != null) {
            mPlayer.release();
            sConvivaVideoAnalytics.reportPlaybackEnded();
            mPlayer = null;
            mIsStreamRequested = false;
        }
    }
